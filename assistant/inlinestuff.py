...
from pykanha.fns.misc import google_search
...
async def repo(e):
    ...
    await e.answer(res, switch_pm="kanha Repo.", switch_pm_param="start")
...
async def piston_run(event):
    try:
        ...
        result = await event.builder.article(
            ...
            text=f'**Inline Usage**\n\n`@{asst.me.username} run python print("hello world")`\n\n[Language List](https://graph.org/kanha-09-01-6)',
        )
        ...
        return await ult.answer(
            [
                await ult.builder.article(
                    title="How to Use?",
                    description="Tl Searcher by kanha",
                    url="https://t.me/Teamkanha",
                    text=text,
                )
            ],
            switch_pm="Tl Search 🔍",
...
InlinePlugin.update(
    {
        ...
        "Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ": "go Teamkanha",
        "WʜɪSᴘᴇʀ": "wspr @username Hello🎉",
        "YᴏᴜTᴜʙᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ": "yt Ed Sheeran Perfect",
        "Piston Eval": "run javascript console.log('Hello kanha')",
        "OʀᴀɴɢᴇFᴏx🦊": "ofox beryllium",
        "Tᴡɪᴛᴛᴇʀ Usᴇʀ": "twitter thekanha",
