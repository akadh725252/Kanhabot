...
from pykanha._misc._decorators import compile_pattern, kanha_cmd
...
ALIVE_NAME = kanha_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = kanha_bot
catub.cat_cmd = kanha_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "kanha")
