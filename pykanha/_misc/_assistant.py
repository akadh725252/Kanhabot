...
from .. import LOGS, asst, udB, kanha_bot
from ..fns.admins import admin_check
from . import append_or_update, owner_and_sudos

OWNER = kanha_bot.full_name

MSG = f"""
**auto bot**
➖➖➖➖➖➖➖➖➖➖
**Owner**: [{OWNER}](tg://user?id={kanha_bot.uid})
**Support**: @Teamkanha
➖➖➖➖➖➖➖➖➖➖
"""
...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/Teamkanha/kanha",
        ),
        Button.url("Support", url="https://t.me/kanhaSupportChat"),
    ]
]
...
def callback(data=None, from_users=[], admins=False, owner=False, **kwargs):
    ...
    if "me" in from_users:
        ...
        from_users.append(kanha_bot.uid)
                    ...
                    await event.answer(
                        [
                            await event.builder.article(
                                ...
                                text=error_text(),
                                buttons=Button.url(
                                    "Report", "https://t.me/kanhaSupportChat"
                                ),
                            )
                        ]
                    )
