...
class kanhaClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from pykanha.fns.FastTelethon import upload_file
        from pykanha.fns.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from pykanha.fns.FastTelethon import download_file
        from pykanha.fns.helper import progress
