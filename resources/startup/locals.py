...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to kanha, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf kanha")
    os.system("git clone https://github.com/Teamkanha/kanha")
    print("\n\nDone")
    os.chdir("kanha")
    clear_screen()
    print(a)
    ...
    all_done = "# kanha Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
    ...
    if isitdone == "y" or isitdone != "n":
        # https://github.com/Teamkanha/kanha/blob/31b9eb1f4f8059e0ae66adb74cb6e8174df12eac/resources/startup/locals.py#L35
        f = open(".env", "w")
        f.write(all_done)
    else:
...
def gen_session():
    print("\nProcessing...")
    # https://github.com/Teamkanha/kanha/main/resources/startup/locals.py#L35
