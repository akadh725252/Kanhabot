...
COPYRIGHT = f"©️ Teamkanha {datetime.now().year}"
...
3. Some of the plugins are disabled for 'Termux Users' to save resources (by adding in EXCLUDE_OFFICIAL).
   - Read More - https://t.me/kanhaUpdates/36
...
{Fore.GREEN}- ULTROID Termux Installation -
  The Main Aim of this script is to deploy kanha with basic requirements and save your phone resources.
{Fore.RESET}
...
print(f"{Fore.YELLOW}* Do you want to get kanha Logs in Colors? [Y/N] ")
...
sleep(0.2)
print(f"Use 'bash startup' to try running kanha.{Fore.RESET}")
sleep(0.5)
print(
    "\nYou can head over to @kanhaSupportChat, if you get stuck somewhere, and need help."
)
sleep(0.5)
print("\nMade with ❤️ by @Teamkanha...")
