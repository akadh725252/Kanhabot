...
from pykanha.fns.tools import metadata, translate
...
from . import inline_mention, is_url_ok, json_parser, mediainfo, kanha_cmd


@kanha_cmd(pattern="tr( (.*)|$)", manager=True)
async def _(event):
...
@kanha_cmd(pattern="bots( (.*)|$)", groups_only=True, manager=True)
async def _(ult):
