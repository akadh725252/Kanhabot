...
from pykanha.fns.misc import get_synonyms_or_antonyms
from pykanha.fns.tools import async_searcher

from . import get_string, kanha_cmd


@kanha_cmd(pattern="meaning( (.*)|$)", manager=True)
