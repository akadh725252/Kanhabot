...
from pykanha.fns.tools import LogoHelper

from . import OWNER_ID, OWNER_NAME, download_file, get_string, mediainfo, kanha_cmd


@kanha_cmd(pattern="logo( (.*)|$)")
    ...
    if not bg_:
        if event.client._bot:
            ...
            async for i in event.client.iter_messages(
                "@kanhaLogos", filter=InputMessagesFilterPhotos
            ):
                pics.append(i)
