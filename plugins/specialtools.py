...
from pykanha.fns.tools import get_google_images, metadata
...
@kanha_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
async def quott_(event):
    ...
    message = await reply.reply("Quotly by kanha", file=file)
    os.remove(file)
    await msg.delete()
    return message
