...
from pykanha.startup.loader import load_addons

from . import LOGS, async_searcher, eod, get_string, safeinstall, kanha_cmd, un_plug


@kanha_cmd(pattern="install", fullsudo=True)
...
@kanha_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
