...
from . import check_filename, get_string, kanha_bot, kanha_cmd


@kanha_cmd(pattern="qrcode( (.*)|$)")
async def cd(e):
    ...
    elif kanha_bot.me.photo and not kanha_bot.me.photo.has_video:
        cimg = (await e.client.get_profile_photos(kanha_bot.uid, limit=1))[0]
